...
const Step = ({ heading, text, number }) => {
  return (
    <div
      className={`flex flex-col  justify-center border p-6 md:72: w-80 h-48 step bg-red-500`}
    >
      <div className="flex justify-between items-center ">
        <div className="text-black text-3xl rounded-full w-12 h-12 items-center justify-center flex border-2 border-black  p-2 "> {number}</div>
...
export const RentSteps = () => {
  return (
    <>
      ...
      <div className="lg:flex-row flex flex-wrap items-center flex-col justify-center gap-4 mx-4 lg:mx-24">
        <Step
          number={1}
