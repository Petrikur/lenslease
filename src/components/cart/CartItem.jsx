    ...
    <div className="flex flex-col md:flex-row items-center justify-between mb-4 mt-10 py-12  shadow-xl border rounded pr-4 relative">
          ...
          {item.discount > 0 ? (
            <>
              ...
              <span className="text-xl">
                {" "}
                €{((item.pricePerDay * (100 - item.discount)) / 100) * 7} /week
              </span>
              <p className="font-bold">€{item.discount ? ((item.pricePerDay * (100 - item.discount)) / 100) : item.pricePerDay} / Day</p>
      ...
      <div className="flex items-center justify-center gap-2 mt-4 md:mt-0">
        <div className="flex flex-col">
          <p className="text-md font-semibold mb-4">Quantity</p>
